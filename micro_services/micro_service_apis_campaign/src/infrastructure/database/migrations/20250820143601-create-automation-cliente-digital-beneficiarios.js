...
module.exports = {
  async up (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.createTable('automation_cliente_digital_beneficiarios', {
      id: {
      ...
      motivo_de_cancelamento: Sequelize.STRING,
      ...
      documento_corretora: Sequelize.STRING,
      nome_corretora: Sequelize.TEXT,
      grupo_corretora: Sequelize.STRING,
      ...
      valor_do_contrato: Sequelize.STRING,
      created_at: {
        type: Sequelize.DATE,
        allowNull: false,
      },
  ...
  async down (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.dropTable('automation_cliente_digital_beneficiarios');
  }
};
