...
module.exports = {
  async up (queryInterface, Sequelize) {
     ...
     */
    await queryInterface.changeColumn('cliente_campanha_campaigns', 'filterByDay', {type: Sequelize.BOOLEAN, allowNull: true, defaultValue: false})
    await queryInterface.changeColumn('cliente_campanha_campaigns', 'filterByMonth', {type: Sequelize.BOOLEAN, allowNull: true, defaultValue: false})
    await queryInterface.changeColumn('cliente_campanha_campaigns', 'filterByYear', {type: Sequelize.BOOLEAN, allowNull: true, defaultValue: false})
  },
