                ...
                async (proposta) => {
                    ...
                    try {
                        ...
                        if (!Array.isArray(contratos) || contratos.length === 0) {
                            logger.warn(`⚠️ Nenhum contrato encontrado para CPF ${proposta.contratante_cpf}`);
                            return;
                        }
                        ...
                        logger.error(`❌ Erro ao consultar contrato para CPF ${proposta.contratante_cpf}: ${erroInterno.message}`);
                    }
                }, 2
            );
